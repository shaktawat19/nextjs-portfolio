      ...
      <div className='container'>
        ...
        <div className='mt-10 md:mt-20 flex flex-col mt-10 gap-20'>
          {portfolioProjects.map((project, index) => (
            <div
              key={project.title}
              className='bg-gray-800 rounded-3xl relative z-0 after:z-10 after:content-[""] after:absolute after:inset-0 after:outline after:outline-2 after:outline-offset-2 after:rounded-3xl
              after:outline-white/20 px-8 pt-8 overflow-hidden md:pt-12 md:px-10 lg:pt-16 lg:px-20 after:pointer-events-none'
            >
              <div
